...
<table class="table table-striped table-wide">
    ...
    <tbody>
        ...
        <tr>
            <td>Class Name:</td>
            <td><a href="?page=class&run=detailed&id=<?php echo htmlspecialchars((string) $student->getclassid()) ?>">
                    <?php echo htmlspecialchars($class->getclassname()) ?></a></td>
        </tr>
        <tr>
            <td>Class ID:</td>
        ...
        <tr>
            <td>Teacher:</td>
            <td><a href="?page=teacher&run=detailed&id=<?php echo htmlspecialchars((string) $teacher->getid())?>">
                    <?php echo htmlspecialchars((string) $teacher->getteachername()) ?></td>
